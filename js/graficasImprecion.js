...
ctx.canvas.width = 60; // Ancho personalizado
ctx.canvas.height = 30; // Altura personalizada
                ...
                options: {
                    ...
                    scales: {
                        x: {
                            ...
                            min: 1,
							max: 3,
                            display: true, // ocultar eje x
                        },
                        y: {
                            beginAtZero: true,
                            min: 1,
                            max: 3,
                            display: true, // ocultar ejey
                        }
    ...
    var miGraficoScatter = new Chart(ctx, {
        ...
        data: {
            datasets: [{
                label: data.ventas,
                data: data.valorVentas,
                backgroundColor: ["#ED9F1B","#ED9F1B",'red','#ED9F1B'],
            }]
        },
        options: {
            scales: {
            ...
            var miGraficoScatter = new Chart(ctx, {
                ...
                data: {
                    datasets: [{
                        label: data.ventas,
                        data: data.valorVentas,
                        backgroundColor: ['red',"#ED9F1B",'#ED9F1B','#ED9F1B'],
